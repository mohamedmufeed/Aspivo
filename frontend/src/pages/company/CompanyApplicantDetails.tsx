...
const CompanyApplicantDetails = () => {
    ...
    const handleStartChat = async () => {
        ...
        const existingConversation = existingConversations.find(
            (conv: any) =>
                conv.targetId === userId || conv.channel === `chat:${companyId}:${userId}`
        );
        try {
                ...
                navigate("/company-messages", {
                    state: {
                        newConversation: {
                            ...
                            userName:
                                existingConversation.targetName ||
                    ...
                    <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-6">
                            ...
                            <div className="bg-white shadow-lg rounded-xl p-6">
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="mt-6 flex justify-end space-x-4">
                                        ...
                                        <button
                                            className="bg-orange-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-orange-700 flex items-center"
                                            onClick={handleStartChat}
                                            disabled={!details?.userId._id}
                                        >
                        ...
                        <div className="w-full md:w-1/2 p-6 space-y-5">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-900">{details?.userId.phoneNumber}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-3">
                            ...
                            <div className="bg-white shadow-lg rounded-xl h-20 flex items-center justify-between px-6">
                                ...
                                <BsDownload
                                    className={`w-6 h-6 text-gray-600 hover:text-gray-800 ${details?.userId.resume ? "cursor-pointer" : "opacity-50 cursor-not-allowed"
                                        }`}
                                    onClick={(e) => {
                    ...
                    <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-6 p-2 px-6">
                        <div className="w-full md:w-1/2 bg-white shadow-lg rounded-xl p-6">
                            ...
                            {details?.userId?.experiences && details.userId.experiences.length > 0 ? (
                                ...
                                <div className="w-8 h-8  rounded-full object-contain flex items-center justify-center text-center">
                                            <div className=" w-3 h-3 bg-orange-200 rounded-full object-contain"></div>
                                        </div>
                                        <div>
                                            <h1 className="font-bold text-lg">
                                                {exp.title || "No position specified"}
                                            </h1>
